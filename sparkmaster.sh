...
# set the parameters for spark. Replace 192.168.2.8 with the IP address of Spark master
echo "export SPARK_MASTER_HOST='192.168.2.8'" >> $SPARK_HOME/conf/spark-env.sh
